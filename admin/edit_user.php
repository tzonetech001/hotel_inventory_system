...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($fullname) || empty($email) || empty($role_id)) {
        ...
        if ($stmt->execute()) {
            logActivity($user_id, 'Edit User', "Updated user: {$user['username']}");
            
            $_SESSION['toast_message'] = "User <strong>" . htmlspecialchars($fullname) . "</strong> updated successfully!";
...
<div class="main-content">
    ...
    <div class="two-column-layout">
        ...
        <div class="form-column">
            <div class="card animate-card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">Update details for <?php echo htmlspecialchars($user['fullname']); ?></p>
                </div>
                <div class="card-body">
                    <form method="POST" action="" id="editUserForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="phone" id="phone" value="<?php echo htmlspecialchars($user['phone'] ?? ''); ?>" placeholder="Enter phone number">
                            </div>
                        </div>
                        
                        <div class="form-row">
                            <div class="form-group">
                                <label><i class="fas fa-badge"></i> Role <span class="required">*</span></label>
                        ...
                        <div class="password-section">
                            <div class="form-group">
                                <label><i class="fas fa-lock"></i> New Password <span class="optional">(optional)</span></label>
        ...
        <div class="info-column">
                ...
                <div class="card-body">
                    <div class="user-details">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value role-badge-display"><?php echo $user['role_name']; ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Current Status:</span>
                            <span class="detail-value status-badge-display <?php echo $user['status']; ?>">
            ...
            <div class="card danger-card animate-card-delayed">
                <div class="card-header">
                    <h3><i class="fas fa-exclamation-triangle"></i> Danger Zone</h3>
                </div>
                <div class="card-body">
                    <div class="danger-actions">
                        <a href="reset_password.php?id=<?php echo $edit_id; ?>" class="btn-danger">
                            <i class="fas fa-key"></i> Reset Password
                        </a>
                        <?php if($edit_id != $_SESSION['user_id']): ?>
                            <a href="view_users.php?delete=<?php echo $edit_id; ?>" class="btn-danger delete" onclick="return confirm('Delete this user? This action cannot be undone!')">
